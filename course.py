...
class CourseClass:
    def __init__(self,root):
        ...
        lbl_courseName=Label(self.root,text="Course Name",font=("goudy old style",15,'bold'),bg="light yellow").place(x=10,y=60)
        ...
        #===entry fields===
        self.txt_courseName=Entry(self.root,textvariable=self.var_courseName,font=("goudy old style",15,'bold'),bg="light yellow")
        ...
        self.txt_description=Text(self.root,width=60,height=13,font=("goudy old style",15,'bold'),bg="light yellow")
       ...
       #===buttons===
        ...
        self.btn_update=Button(self.root,text="Update",font=("goudy old style",15,'bold'),bg="#4caf50",fg="white",cursor="hand2",command=self.updated)
        ...
        lbl_search_courseName=Label(self.root,text="Course Name",font=("goudy old style",15,'bold'),bg="light yellow").place(x=700,y=60)
        ...
        btn_search=Button(self.root,text="Search",font=("goudy old style",15,'bold'),bg="#03a9f4",fg="white",cursor="hand2",command=self.search).place(x=1070,y=60,width=120,height=280)
       #====content====
...
# =====================================================
    ...
    def get_data(self,ev):
        self.txt_courseName.config(state='readonly')  #to enable
        self.txt_courseName
    ...
    def updated(self):
        ...
        try:
            if self.var_courseName.get()=="":
                ...
                row=cur.fetchone()
                if row==None:
                    messagebox.showerror("SELECT course fro list",parent=self.root)
                else:
